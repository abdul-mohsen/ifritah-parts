...
// Non-HK make hints ΓÇö high-signal starting fragments that let us suggest a
...
var nonHKMakeHints = []struct {
	...
	// alpha starts (Ford AL3Z-ΓÇª, Mazda LF01-ΓÇª).
}
...
func IsHKOEM(rawOEM string) HKScopeResult {
	...
	// format regexes look at it explicitly. `26300 - 35505` ΓåÆ `26300-35505`.
	...
	// Not the HK 5-5 pattern ΓÇö try to suggest a make from the deny-list.
	if format == "unknown" {
